...
const AllDonations = () => {
    ...
    return (
        <div className="bg-gray-900 min-h-screen py-6 px-4 sm:px-6 md:px-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-center text-white mb-8">All Donations</h1>

            {output.length > 0 ? (
                output.map((donation, index) => {
                    return (
                        <div key={index} className="bg-gray-800 p-4 sm:p-6 rounded-lg shadow-lg mb-4">
